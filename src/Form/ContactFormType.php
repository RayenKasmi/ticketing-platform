    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('firstname', TextType::class, [
                'mapped' => false,
                'required' => false,
                'constraints' => [ new NotBlank(['message' => 'Please enter your firstname'])]
            ])
            ->add('lastname', TextType::class, [
                'mapped' => false,
                'required' => false,
                'constraints' => [ new NotBlank(['message' => 'Please enter your lastname'])]
            ])
            ...
            ->add('message', TextareaType::class, [
                ...
                'required' => false,
                'constraints' => [
                    new NotBlank(['message' => 'Please enter the message']),
                    new Length([
                        'min' => 4,
